...
class _$MediaImpl implements _Media {
  ...
  @override
  String toString() {
    return 'Media(id: $id, modelType: $modelType, modelId: $modelId, collectionName: $collectionName, name: $name, fileName: $fileName, mimeType: $mimeType, disk: $disk, size: $size, customProperties: $customProperties)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, modelType, modelId,
      collectionName, name, fileName, mimeType, disk, size, customProperties);
